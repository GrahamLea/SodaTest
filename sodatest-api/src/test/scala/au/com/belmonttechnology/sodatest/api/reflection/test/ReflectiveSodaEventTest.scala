...
package au.com.belmonttechnology.sodatest.api.reflection { package test {

import au.com.belmonttechnology.coercion.Coercion
import au.com.belmonttechnology.coercion.CoercionRegister
